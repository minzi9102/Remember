...
| ID | 文件 | phase | 用例数 | 状态 |
|---|---|---:|---:|---|
| P1-T1 | `phase-1/p1-t1-project-layering.md` | 1 | 4 | TODO |
| P1-T2 | `phase-1/p1-t2-config-runtime-mode.md` | 1 | 4 | TODO |
| P1-T3 | `phase-1/p1-t3-command-envelope.md` | 1 | 4 | TODO |
| P1-T4 | `phase-1/p1-t4-tracing-error-mapping.md` | 1 | 4 | TODO |
| P1-T5 | `phase-1/p1-t5-shared-dto.md` | 1 | 4 | TODO |
| P2-T1 | `phase-2/p2-t1-isomorphic-migrations.md` | 2 | 4 | TODO |
...
| P3-T1 | `phase-3/p3-t1-dualsync-repository.md` | 3 | 4 | PASS |
| P3-T2 | `phase-3/p3-t2-parallel-tx-timeout.md` | 3 | 4 | TODO |
| P3-T3 | `phase-3/p3-t3-rollback-error-codes.md` | 3 | 4 | TODO |
| P3-T4 | `phase-3/p3-t4-single-side-compensation-alerts.md` | 3 | 4 | TODO |
| P3-T5 | `phase-3/p3-t5-startup-self-heal.md` | 3 | 4 | TODO |
| P4-T1 | `phase-4/p4-t1-global-hotkey.md` | 4 | 4 | TODO |
| P4-T2 | `phase-4/p4-t2-list-timeline-navigation.md` | 4 | 4 | TODO |
| P4-T3 | `phase-4/p4-t3-keyboard-shortcuts.md` | 4 | 4 | TODO |
...
- 子任务: 26
- 用例总数: 104
- 状态值: TODO / RUNNING / PASS / FAIL / BLOCKED
